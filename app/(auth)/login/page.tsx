            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4">
                    ...
                    <button
                        ...
                        className="w-full h-10 border border-border bg-card text-foreground font-bold text-xs uppercase tracking-widest rounded-md hover:bg-muted transition-all flex items-center justify-center gap-2"
                    >
