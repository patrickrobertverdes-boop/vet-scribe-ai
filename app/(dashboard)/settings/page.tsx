                    ...
                    <div className="glass rounded-[1.5rem] p-6 md:p-12 border border-slate-200/50 dark:border-slate-700/50 shadow-2xl space-y-8 md:space-y-12 bg-card/40 min-h-[600px]">
                        ...
                        {activeTab === 'Server Bridge' && (
                            <div className="space-y-12 animate-in fade-in duration-500">
                                <div className="space-y-8">
                                    <h2 className="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.4em] flex items-center gap-4">
                                        <HardDrive className="h-4 w-4" /> On-Premise Gateway
                                    </h2>

                                    {/* Electron Check - If window.avimarkConnector exists (or just check userAgent/platform if simpler for now) 
                                    ...
                                    */}
                                    <div className="p-8 rounded-3xl bg-slate-50 dark:bg-slate-900 border border-border shadow-inner space-y-8 relative overflow-hidden">
                                        ...
                                        {/* Connection Status */}
                                        <div className="flex items-center gap-3 px-4 py-2 bg-emerald-500/10 border border-emerald-500/20 rounded-lg w-fit">
                                    ...
                                    <div className="p-6 rounded-2xl bg-orange-50 dark:bg-orange-950/20 border border-orange-200 dark:border-orange-900/50 flex items-start gap-5">
                                        ...
                                        <div className="space-y-2">
                                            <h4 className="text-xs font-bold text-orange-800 dark:text-orange-200 uppercase tracking-wide">Desktop Bridge Required</h4>
