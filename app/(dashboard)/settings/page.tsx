                        ...
                        {activeTab === 'Server Bridge' && (
                            <div className="space-y-12 animate-in fade-in duration-500">
                                <div className="space-y-8">
                                    ...
                                    <div className="space-y-10">
                                        <div className="space-y-4">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <h3 className="text-sm font-bold text-foreground tracking-tight">On-Premise Clinical Database</h3>
                                            </div>
                                            <p className="text-xs text-muted-foreground leading-relaxed max-w-xl">
                                                Configure the direct link between VetScribe and your clinic management system.
                                                This creates a dedicated read-only shadow buffer for clinical processing.
                                            </p>
                                        </div>
                                        ...
                                        <div className="space-y-8 max-w-2xl">
                                            <div className="space-y-3">
                                                ...
                                                <p className="text-[9px] text-muted-foreground font-medium uppercase tracking-tight">
                                                    * Clinical data root (e.g. C:\AVImark\Data)
                                                </p>
                                            </div>

                                            <div className="space-y-3">
                                                <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest flex items-center gap-2">
                                                    <ArrowRightLeft className="h-3 w-3" /> Synchronicity
                                                </label>
                                        ...
                                        <div className="pt-8 border-t border-border flex flex-col sm:flex-row gap-4">
                                            <button
                                                ...
                                                className="flex-1 h-12 bg-primary text-primary-foreground rounded-xl text-[10px] font-bold uppercase tracking-widest hover:opacity-90 transition-all flex items-center justify-center gap-2 active:scale-95 shadow-lg shadow-primary/10"
                                            >
                                                <RefreshCw className="h-4 w-4" />
                                                Force Refresh
                                            </button>
                                            <button className="flex-1 h-12 border border-border rounded-xl text-foreground hover:bg-muted text-[10px] font-bold uppercase tracking-widest transition-all bg-card flex items-center justify-center gap-2 active:scale-95">
                                    ...
                                    <div className="p-8 rounded-xl bg-primary/5 border border-primary/10 flex items-start gap-6 border-dashed">
                                        <div className="h-10 w-10 rounded-xl bg-card border border-border flex items-center justify-center shrink-0">
                                            <Download className="h-5 w-5 text-primary" />
                                        </div>
                                        <div className="space-y-3">
                                            <h4 className="text-[10px] font-bold text-foreground uppercase tracking-widest">Desktop Agent v.1.0.4</h4>
                                            <p className="text-[11px] text-muted-foreground leading-relaxed font-medium">
                                                Direct filesystem access requires the VetScribe Pro Bridge Agent for clinical integrity.
                                            </p>
                                            <button className="text-[10px] font-bold text-primary hover:underline transition-all uppercase tracking-widest flex items-center gap-2">
